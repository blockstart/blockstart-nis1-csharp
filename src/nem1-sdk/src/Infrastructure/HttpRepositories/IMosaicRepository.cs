...
namespace io.nem1.sdk.Infrastructure.HttpRepositories
{
    ...
    interface IMosaicRepository
    {
        ...
        IObservable<Mosaic> GetMosaic(string mosaicId);
        ...
        IObservable<List<Mosaic>> GetMosaics(List<string> mosaicIds);
        ...
        /// <returns>IObservable&lt;List&lt;MosaicInfoDTO&gt;&gt;.</returns>
        IObservable<List<Mosaic>> GetMosaicsFromNamespace(NamespaceId namespaceId);
